...
| P00-8 | 00    | Current SHA has external CI evidence                               | active           | PR #1 exposed pnpm store then Turbo DATABASE_URL filtering; both fixed, CI rerun pending                     | read back replacement-SHA checks       |
