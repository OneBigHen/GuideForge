...
| P01   | 01    | Single-owner companion auth and secret boundary                    | active           | `apps/companion` + `/settings`; 10/10 security tests; `pnpm check --force` 120/120; current-SHA CI pending   | commit, push, read back required CI    |
