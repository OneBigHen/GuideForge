...
| P00-8 | 00    | Current SHA has external CI evidence                               | active           | PR #1 exposed pnpm store, Turbo env, and gitleaks permission; fixes pending CI                               | read back replacement-SHA checks       |
